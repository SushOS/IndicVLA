...
The focused MuRIL-to-OMG Hindi adapter run has a separate, end-to-end runbook:
[`docs/hindi_adapter_training.md`](hindi_adapter_training.md). It uses the
`100m_hindi_adapter` experiment and does not run baseline sweeps.
